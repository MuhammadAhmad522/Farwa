document.addEventListener('DOMContentLoaded', function() {
  ...
  let eventDate = new Date( yearOfTheEvent, 01, 08 )
  const isItFebruary4th = currentTime.getMonth() === 01 && currentTime.getDate() === 08
  ...
  function countdown() {
    ...
    if ( now > eventDate ) {
      eventDate = new Date( yearOfTheEvent + 1, 01, 08 )
    } else if ( now.getFullYear() === eventDate.getFullYear() + 1 ) {
      eventDate = new Date( now.getFullYear(), 01, 08 )
    }
